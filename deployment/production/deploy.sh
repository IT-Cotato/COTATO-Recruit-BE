...
# 서비스 및 컨테이너 이름 설정
BLUE_SERVICE="prod-blue"
GREEN_SERVICE="prod-green"
BLUE_CONTAINER="prod-blue"
GREEN_CONTAINER="prod-green"
REDIS_SERVICE="prod-redis"
...
# SSL 인증서 확인
if [ ! -f ~/ssl/prod/fullchain.pem ] || [ ! -f ~/ssl/prod/privkey.pem ]; then
    echo "[ERROR] SSL certificates not found at ~/ssl/prod/"
...
# 9. 배포 완료
echo "[8/8] Production Deployment completed. Active: $IDLE_COLOR"
echo "=========================================="
