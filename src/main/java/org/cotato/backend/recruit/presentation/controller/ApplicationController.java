...
@Tag(name = "지원서 화면 API", description = "지원서 작성 및 관리 관련 화면 API")
@RestController
...
public class ApplicationController {
	...
	public ApiResponse<BasicInfoResponse> getBasicInfo(
		...
		BasicInfoResponse response =
				applicationService.getBasicInfo(userDetails.getUserId(), applicationId);
		return ApiResponse.success(response);
	}
	...
	public ApiResponse<Void> saveBasicInfo(
		...
		applicationService.saveBasicInfo(userDetails.getUserId(), applicationId, request);
