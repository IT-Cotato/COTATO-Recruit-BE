...
public class SubmittedApplicationService {
	 ...
	 * @return 기본 인적사항 응답
	 */
	public SubmittedApplicationBasicInfoResponse getBasicInfo(Long userId, Long applicationId) {
		Application application = getApplicationWithAuth(applicationId, userId);
		return SubmittedApplicationBasicInfoResponse.from(application);
	}
	 ...
	 */
	public SubmittedApplicationPartQuestionResponse getPartQuestionsWithAnswers(
	 ...
	 * @return 기타 정보 응답
	 */
	public SubmittedApplicationEtcQuestionsResponse getEtcInfo(Long userId, Long applicationId) {
		Application application = getApplicationWithAuth(applicationId, userId);
