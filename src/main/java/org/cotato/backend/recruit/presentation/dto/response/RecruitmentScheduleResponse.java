...
public record RecruitmentScheduleResponse(
		...
		@Schema(description = "지원 시작일자", example = "2025-01-01T00:00:00") LocalDateTime applicationStartDate,
		@Schema(description = "지원 종료일자", example = "2025-01-07T23:59:00") LocalDateTime applicationEndDate,
		@Schema(description = "서류 발표일자", example = "2025-01-10T18:00:00") LocalDateTime documentAnnouncement,
		@Schema(description = "면접 평가 시작일자", example = "2025-01-13T10:00:00") LocalDateTime interviewStartDate,
		@Schema(description = "면접 평가 종료일자", example = "2025-01-14T18:00:00") LocalDateTime interviewEndDate,
		@Schema(description = "최종 발표일자", example = "2025-01-17T18:00:00") LocalDateTime finalAnnouncement,
		@Schema(description = "OT 일자", example = "2025-01-20T14:00:00") LocalDateTime otDate,
		@Schema(description = "코커톤 일자", example = "2025-01-20T14:00:00") LocalDateTime cokerthonDate,
		@Schema(description = "데모데이 일자", example = "2025-01-20T14:00:00") LocalDateTime demoDayDate) {
