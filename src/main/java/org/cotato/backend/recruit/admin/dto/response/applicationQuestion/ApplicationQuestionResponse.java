...
public record ApplicationQuestionResponse(Integer sequence, String content, Integer maxLength) {
	public static ApplicationQuestionResponse from(Question question) {
		return new ApplicationQuestionResponse(
				question.getSequence(), question.getContent(), question.getMaxLength());
	}
}
