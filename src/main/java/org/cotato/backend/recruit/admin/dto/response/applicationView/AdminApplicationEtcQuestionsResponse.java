...
public record AdminApplicationEtcQuestionsResponse(
	...
	public static AdminApplicationEtcQuestionsResponse of(
			...
			LocalDateTime ot,
			LocalDateTime cokerthon,
			LocalDateTime demoDay) {
		...
		String cokerthonDate = DateFormatter.formatMonthDay(cokerthon);
		String demoDayDate = DateFormatter.formatMonthDay(demoDay);
